...
- **Sub-version:** v0.8.1 just tagged. **20 sub-versions tagged: v0.1.0 / v0.1.1 / v0.1.2 / v0.2.0 / v0.2.1 / v0.3.0 / v0.4.0 / v0.4.1 / v0.4.2 / v0.4.3 / v0.5.0 / v0.5.1 / v0.5.2 / v0.5.3 / v0.6.0 / v0.6.1 / v0.7.0 / v0.7.1 / v0.8.0 / v0.8.1.** Counts (git-verified post-v0.8.1, pre-commit): ~25 commits, ~183+ tracked files, ~33k lines added net. (Earlier "30,000+/22,000+/13,000+" estimates were inflated; corrected per Article VI honest reporting.)
...
- **Phases shipped:** v0.1.0 → v0.8.1 inclusive (20 tags). Target: v1.0.0 (full Layer 1 release). Layer 2 Studio: v2.0.0+ (per ADR-008).
- **Open features:** 1 (the BeQuite v1.0.0 build; 6 sub-versions remain to v1.0.0 — v0.9.0 next).
...
| v0.9.0 | Three example projects (bookings-saas + ai-tool-wrapper + tauri-note-app) with full seven-phase walks executed; receipts archived; HANDOFF.md generated | **next** |
