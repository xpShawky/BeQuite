...
**Total commands:** 59 active + 1 deprecated alias (`/bq-add-feature` → `/bq-feature`) — every command carries a stable display-only catalog ID (W0–W5 / N / O / C / M); canonical map `.bequite/commands/COMMAND_ID_MAP.md`
