...
- **Sub-version:** v0.8.0 just tagged. **19 sub-versions tagged: v0.1.0 / v0.1.1 / v0.1.2 / v0.2.0 / v0.2.1 / v0.3.0 / v0.4.0 / v0.4.1 / v0.4.2 / v0.4.3 / v0.5.0 / v0.5.1 / v0.5.2 / v0.5.3 / v0.6.0 / v0.6.1 / v0.7.0 / v0.7.1 / v0.8.0.** Counts (git-verified post-v0.8.0, pre-commit): ~24 commits, ~180+ tracked files, ~32k lines added net. (Earlier "30,000+/22,000+/13,000+" estimates were inflated; corrected per Article VI honest reporting.)
...
- **Phases shipped:** v0.1.0 → v0.8.0 inclusive (19 tags). Target: v1.0.0 (full Layer 1 release). Layer 2 Studio: v2.0.0+ (per ADR-008).
- **Open features:** 1 (the BeQuite v1.0.0 build; 7 sub-versions remain to v1.0.0 — v0.8.1 next).
...
| v0.8.1 | Live pricing fetch (best-effort; 24h cache; offline fallback) | **next** |
