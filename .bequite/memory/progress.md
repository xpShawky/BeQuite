...
- **Sub-version:** v0.7.1 just tagged. **18 sub-versions tagged: v0.1.0 / v0.1.1 / v0.1.2 / v0.2.0 / v0.2.1 / v0.3.0 / v0.4.0 / v0.4.1 / v0.4.2 / v0.4.3 / v0.5.0 / v0.5.1 / v0.5.2 / v0.5.3 / v0.6.0 / v0.6.1 / v0.7.0 / v0.7.1.** Counts (git-verified post-v0.7.1, pre-commit): ~23 commits, ~173+ tracked files, ~30k lines added net. (Earlier "30,000+/22,000+/13,000+" estimates were inflated; corrected per Article VI honest reporting.)
...
- **Phases shipped:** v0.1.0 → v0.7.1 inclusive (18 tags). Target: v1.0.0 (full Layer 1 release). Layer 2 Studio: v2.0.0+ (per ADR-008).
- **Open features:** 1 (the BeQuite v1.0.0 build; 8 sub-versions remain to v1.0.0 — v0.8.0 next).
...
| v0.8.0 | Multi-model routing (cost-aware AiProvider adapters: Anthropic + OpenAI + Google + DeepSeek + Ollama; routing.json schema; stop-cost-budget hook) | **next** |
